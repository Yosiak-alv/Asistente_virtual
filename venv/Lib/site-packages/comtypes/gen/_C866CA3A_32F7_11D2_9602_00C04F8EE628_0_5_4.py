...
__all__ = [
    'eLEXTYPE_PRIVATE1', 'SPEI_MIN_TTS', 'SECHighConfidence',
    'SPFM_OPEN_READWRITE', 'SPCT_COMMAND', 'eLEXTYPE_PRIVATE17',
    'SVSFNLPSpeakPunc', 'DISPID_SWFEExtraData', 'SPWORDTYPE',
    'SPAUDIOSTATE', 'SDKLLocalMachine', 'SINone',
    'SpeechPropertyResponseSpeed', 'DISPID_SRCEventInterests',
    'SGLexicalNoSpecialChars', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_MAX_TTS', 'DISPID_SAFGetWaveFormatEx', 'SPSFunction',
    'DISPID_SRCEHypothesis', 'DISPID_SLPPhoneIds', 'DISPID_SOTCId',
    '_ISpeechVoiceEvents', 'SpeechRecoEvents',
    'DISPID_SRGDictationLoad', 'ISpeechPhraseInfoBuilder',
    'SAFT8kHz16BitMono', 'DISPID_SRGReset', 'DISPID_SVPause',
    'DISPID_SASetState', 'DISPID_SOTIsUISupported',
    'ISpeechGrammarRuleState', 'DISPID_SpeechAudioStatus',
    'DISPID_SASState', 'DISPID_SpeechPhraseInfo',
    'DISPID_SGRSTPropertyValue', '_ISpeechRecoContextEvents',
    'SVSFParseSsml', 'SRTReSent', 'DISPID_SLPLangId',
    'DISPID_SGRSTRule', 'SDTProperty', 'SAFT48kHz16BitMono',
    'SPCS_DISABLED', 'SAFTGSM610_22kHzMono',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPEs_NewEnum',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SGRClear',
    'DISPID_SGRSTPropertyId', 'DISPID_SABIMinNotification',
    'DISPID_SLGenerationId', 'SSTTDictation', 'SpeechFormatType',
    'SpeechDisplayAttributes', 'SREFalseRecognition',
    'ISpRecognizer2', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRAudioInputStream', 'SPWORDPRONUNCIATION', 'SPSHT_EMAIL',
    'DISPID_SPCLangId', 'SpeechEngineProperties',
    'DISPID_SpeechPhraseProperty', 'eLEXTYPE_RESERVED6',
    'DISPID_SVEStreamEnd', 'SP_VISEME_19', 'SPRST_NUM_STATES',
    'DISPID_SLRemovePronunciation', 'SpAudioFormat',
    'DISPID_SRCEEndStream', 'SAFT48kHz16BitStereo', 'SVP_19',
    'SECFIgnoreCase', 'DISPID_SMSALineId', 'DISPID_SDKEnumValues',
    'DISPID_SPIAudioSizeTime', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechWaveFormatEx', 'SRTStandard',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SBSRead', 'SVEBookmark',
    'DISPID_SPAPhraseInfo', 'ISpEventSink', 'SRSEDone',
    'SPPARTOFSPEECH', 'DISPID_SPPBRestorePhraseFromMemory',
    'ISpeechAudioFormat', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPRDisplayAttributes', 'SpeechCategoryAudioOut', 'SVP_3',
    'SpObjectTokenCategory', 'DISPID_SGRsCommit',
    'DISPID_SPRuleNumberOfElements', 'SPINTERFERENCE_NOSIGNAL',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SLWWord',
    'SAFT8kHz8BitStereo', 'SpFileStream', 'ISpeechRecoResultDispatch',
    'SPEI_RESERVED1', 'DISPID_SWFESamplesPerSec',
    'DISPID_SGRSTWeight', 'SP_VISEME_4', 'DISPID_SRCCreateGrammar',
    'DISPID_SRCEAudioLevel', 'SAFT22kHz16BitMono',
    'SpeechRetainedAudioOptions', 'SVPOver', 'DISPID_SAFGuid',
    'ISpeechGrammarRules', 'SPEI_RESERVED3', 'SpeechEngineConfidence',
    'DISPID_SPIElements', 'SRATopLevel', 'STCInprocHandler',
    'SAFTNoAssignedFormat', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPPsItem', 'DISPID_SRRTStreamTime',
    'DISPID_SVEStreamStart', 'SASPause', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechPropertyAdaptationOn', 'SpeechSpecialTransitionType',
    'DISPID_SPRuleConfidence', 'SPAS_PAUSE', 'ISpeechPhoneConverter',
    'SpResourceManager', 'DISPID_SRCBookmark',
    'DISPID_SGRAddResource', 'SFTSREngine',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPIRetainedSizeBytes', 'SVP_20', 'ISpeechGrammarRule',
    'SpeechGrammarRuleStateTransitionType', 'SPPS_RESERVED3',
    'SFTInput', 'DISPID_SPPFirstElement', 'SECFEmulateResult',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechBaseStream',
    'DISPID_SPRuleFirstElement', 'SpPhoneticAlphabetConverter',
    'SAFT11kHz8BitMono', '_RemotableHandle', 'SPAUDIOSTATUS',
    'DISPID_SpeechLexiconPronunciation', 'SSTTWildcard', 'SGRSTTRule',
    'DISPID_SABufferNotifySize', 'SAFT16kHz8BitMono',
    'DISPID_SVIsUISupported', 'ISpObjectTokenCategory',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpeechAddRemoveWord',
    'DISPID_SpeechPhraseElement', 'DISPID_SCSBaseStream',
    'SPSHORTCUTPAIR', 'IEnumSpObjectTokens',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPCIdToPhone',
    'DISPID_SPIRule', 'SRCS_Enabled', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPERetainedStreamOffset', 'SVEViseme', 'STCRemoteServer',
    'DISPID_SOTDisplayUI', 'DISPID_SRGetFormat', 'DISPID_SBSWrite',
    'SGSEnabled', 'SREAdaptation', 'ISpRecognizer3', 'ISpMMSysAudio',
    'DISPID_SMSSetData', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPEI_VOICE_CHANGE', 'SpeechRecognizerState',
    'SpInProcRecoContext', 'SPLO_STATIC', 'eLEXTYPE_PRIVATE10',
    'SpeechUserTraining', 'eLEXTYPE_RESERVED10',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPAs_NewEnum',
    'SGDisplay', 'SRARoot', 'DISPID_SPEsCount', 'SpeechVisemeType',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SRRTLength',
    'SP_VISEME_0', 'DISPID_SVEWord', 'DISPID_SRCESoundStart',
    'DISPID_SpeechRecoContext', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRCESoundEnd', 'SAFT44kHz8BitStereo', 'ISpEventSource',
    'SAFT24kHz8BitStereo', 'SWPKnownWordPronounceable',
    'SPSHT_NotOverriden', 'SRSActiveAlways', 'DISPID_SOTs_NewEnum',
    'SWTDeleted', 'SINoSignal', 'SpeechRunState',
    'DISPID_SRRSetTextFeedback', 'SECFDefault', 'SVF_Emphasis',
    'SPSNotOverriden', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SpeechGrammarRules', 'SpeechEmulationCompareFlags',
    '_SPAUDIOSTATE', 'SVP_0', 'eLEXTYPE_APP', 'SPBO_PAUSE',
    'SPPS_NotOverriden', 'DISPID_SpeechLexiconWords',
    'SPAUDIOOPTIONS', 'SPEI_INTERFERENCE', 'ISpeechPhraseElements',
    'ISpStream', 'SPEI_SR_PRIVATE', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRCEFalseRecognition', 'ISpStreamFormatConverter',
    'DISPID_SLWType', 'DISPID_SGRAddState', 'ISpeechAudioStatus',
    'SpeechVoicePriority', 'SAFTCCITT_uLaw_44kHzMono',
    'SDTDisplayText', 'SVP_8', 'SP_VISEME_6', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRRecognizer', 'SDTAll', 'DISPID_SRCEEnginePrivate',
    'SpeechAudioState', 'SDA_Two_Trailing_Spaces',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpDataKey', 'SVP_12',
    'SGRSTTWord', 'SP_VISEME_20', 'DISPID_SpeechPhraseProperties',
    'SAFT32kHz8BitMono', 'SPPS_Verb', 'SAFTCCITT_ALaw_8kHzStereo',
    'eLEXTYPE_PRIVATE6', 'ISpeechAudioBufferInfo',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPIEngineId',
    'SpSharedRecoContext', 'DISPID_SRDisplayUI', 'SVF_None',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRRSaveToMemory',
    'DISPID_SPAsItem', 'DISPID_SGRSTsItem', 'DISPID_SPCPhoneToId',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRCEInterference', 'DISPID_SVAlertBoundary',
    'SPEI_ADAPTATION', 'SPRST_ACTIVE', 'ISpShortcut', 'SVEAllEvents',
    'SPSLMA', 'SP_VISEME_13', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SITooLoud', 'DISPID_SRGState', 'DISPID_SRCEPropertyStringChange',
    'IInternetSecurityManager', 'DISPID_SRRRecoContext', 'SPPS_LMA',
    'SRCS_Disabled', 'DISPID_SRCEStartStream',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpeechObjectTokenCategory',
    'SAFTNonStandardFormat', 'SPEI_RECOGNITION', 'ISpeechLexicon',
    'SVP_1', 'SPGS_DISABLED', 'DISPID_SOTSetId', 'SpeechMicTraining',
    'SpeechCategoryAudioIn', 'SPEI_PHRASE_START', 'SPGRAMMARWORDTYPE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRSAddWordTransition',
    'ISpStreamFormat', 'DISPID_SRGRules', 'SVP_18',
    'DISPID_SpeechCustomStream', 'SPEI_REQUEST_UI', 'SPSHORTCUTTYPE',
    'SP_VISEME_9', 'DISPID_SPEAudioSizeTime', 'SVPNormal',
    'SREBookmark', 'DISPID_SWFEBitsPerSample',
    'ISpeechGrammarRuleStateTransitions', 'SPRST_INACTIVE_WITH_PURGE',
    'SPSUnknown', 'DISPID_SpeechPhraseAlternate', 'SASClosed',
    'SAFTGSM610_8kHzMono', 'DISPID_SDKCreateKey',
    'Speech_Max_Pron_Length', 'DISPID_SGRs_NewEnum', 'SREHypothesis',
    'SPSMF_SAPI_PROPERTIES', 'SDTReplacement', 'DISPID_SAFType',
    'SPXRO_Alternates_SML', 'DISPID_SpeechAudioFormat',
    'SPSERIALIZEDPHRASE', 'DISPID_SPIAudioStreamPosition',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRProfile',
    'SPXRO_SML', 'SPWF_SRENGINE', 'SAFT32kHz8BitStereo',
    'SPEI_SR_RETAINEDAUDIO', 'SDA_No_Trailing_Space',
    'SAFT12kHz16BitMono', 'SAFTCCITT_uLaw_11kHzMono', 'SPAR_Unknown',
    'eLEXTYPE_USER_SHORTCUT', 'SpPhraseInfoBuilder',
    'SpeechCategoryAppLexicons', 'SPAR_Low', 'DISPID_SDKSetLongValue',
    'SVSFIsXML', 'DISPID_SVVoice', 'SRTAutopause',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpRecoContext',
    'DISPID_SPRuleName', 'SpShortcut', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SAStatus', 'DISPID_SOTCGetDataKey', 'STSF_CommonAppData',
    'DISPID_SPEEngineConfidence', 'SpeechAudioFormatGUIDText',
    'SAFT16kHz16BitStereo', 'SPPHRASEELEMENT', 'SPWT_LEXICAL',
    'SAFT16kHz16BitMono', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPPS_Interjection', 'SPFM_CREATE', 'ISpeechPhraseElement',
    'eLEXTYPE_PRIVATE4', 'SpeechTokenValueCLSID', 'SpeechLoadOption',
    'DISPID_SGRSTPropertyName', 'DISPIDSPTSI', 'DISPID_SVSPhonemeId',
    'SREAudioLevel', 'DISPID_SRRTOffsetFromStart', 'SPEI_PHONEME',
    'DISPID_SGRSTType', 'DISPID_SPPValue',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_SENTENCE_BOUNDARY',
    'SPEI_END_INPUT_STREAM', 'SRSActive',
    'SPINTERFERENCE_LATENCY_WARNING', 'SGDSActiveUserDelimited',
    'ISpeechPhraseProperty', 'DISPID_SMSAMMHandle',
    'DISPID_SVSInputSentenceLength', 'DISPID_SGRsCommitAndSave',
    'DISPID_SBSSeek', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPIStartTime', 'DISPID_SpeechPhraseElements',
    'ISpRecognizer', 'SVESentenceBoundary', 'SPVOICESTATUS',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechGrammarRuleState',
    'SpeechAudioProperties', 'Speech_StreamPos_RealTime',
    'SPSInterjection', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SASCurrentSeekPosition', 'SPDKL_CurrentUser',
    'SpCompressedLexicon', 'SAFTGSM610_11kHzMono',
    'DISPID_SWFEBlockAlign', 'SPFM_NUM_MODES', 'SPBO_NONE',
    'SAFT24kHz16BitStereo', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SVSVisemeId', 'SPAS_STOP', 'DISPID_SPEActualConfidence',
    'DISPID_SPRNumberOfElements', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLWs_NewEnum', 'ISpeechPhraseRules',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRGCmdLoadFromFile',
    'ISpVoice', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SAEventHandle', 'DISPID_SRRTTickCount', 'SRAExport',
    'eLEXTYPE_PRIVATE7', 'SAFT24kHz16BitMono', 'SpeechTokenKeyFiles',
    'DISPID_SRCResume', '__MIDL_IWinTypes_0009', 'SSTTTextBuffer',
    'DISPID_SRCEPhraseStart', 'DISPID_SRCERequestUI', 'SpMMAudioIn',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVSInputWordPosition', 'SP_VISEME_7',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SOTsCount',
    'SPCT_SUB_COMMAND', 'DISPID_SPPNumberOfElements',
    'ISequentialStream', 'DISPID_SGRSRule', 'SRESoundStart',
    'SGDSInactive', 'ISpObjectToken', 'SpeechGrammarTagWildcard',
    'SVSFParseSapi', 'ISpeechLexiconWords', 'SPPS_RESERVED4',
    'SpeechCategoryPhoneConverters', 'SAFT44kHz16BitMono',
    'DISPID_SPIProperties', 'DISPID_SAVolume', 'DISPID_SOTCategory',
    'ISpeechPhraseReplacement', 'DISPID_SLAddPronunciation',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRGCommit', 'SRAInterpreter', 'DISPID_SRState',
    'SAFTText', 'DISPID_SOTDataKey', 'SVP_10',
    'DISPID_SpeechRecoContextEvents',
    'DISPID_SRCCreateResultFromMemory', 'SDTLexicalForm',
    'SPFM_CREATE_ALWAYS', 'eLEXTYPE_PRIVATE13', 'SSSPTRelativeToEnd',
    'SECNormalConfidence', 'SpeechRecoContextState',
    'DISPID_SRCEPropertyNumberChange', 'ISpNotifySink',
    'SPEI_WORD_BOUNDARY', 'DISPID_SGRsFindRule', 'SREAllEvents',
    'DISPID_SPERetainedSizeBytes', 'SpeechRecoProfileProperties',
    'ISpeechObjectToken', 'ISpeechTextSelectionInformation',
    'DISPID_SVSkip', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVSRunningState', 'DISPID_SpeechDataKey',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechMMSysAudio', 'SP_VISEME_2',
    'SPWT_PRONUNCIATION', 'DISPID_SDKGetStringValue',
    'SAFT8kHz8BitMono', 'SP_VISEME_12', 'DISPID_SLWLangId',
    'SP_VISEME_10', 'SPLO_DYNAMIC', 'DISPID_SpeechPhraseBuilder',
    'SPSVerb', 'SpeechPropertyNormalConfidenceThreshold',
    'ISpeechRecoResult2', 'SpeechRuleAttributes', 'SP_VISEME_17',
    'STCAll', 'SPTEXTSELECTIONINFO', 'SPEI_END_SR_STREAM',
    'SGDSActive', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechPhraseReplacements', 'SVEWordBoundary',
    'SPVPRI_OVER', 'DISPID_SGRSAddRuleTransition',
    'eWORDTYPE_DELETED', 'SPSModifier', 'SVP_11',
    'SPSTREAMFORMATTYPE', 'DISPID_SGRsDynamic', 'SVEAudioLevel',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechPhraseRules',
    'SpVoice', 'SP_VISEME_8', 'SPRULE', 'SPPHRASEREPLACEMENT',
    'DISPID_SGRSTsCount', 'ISpRecoContext2', 'SPPS_Noncontent',
    'SASStop', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SP_VISEME_16',
    'DISPID_SRSetPropertyString',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_RESERVED4',
    'DISPID_SPISaveToMemory', 'DISPID_SDKGetBinaryValue',
    'SpeechWordType', 'eLEXTYPE_PRIVATE12', 'SAFT44kHz16BitStereo',
    'SGSDisabled', 'SpeechCategoryVoices', 'SPEI_START_SR_STREAM',
    'DISPID_SGRSTransitions', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SOTCEnumerateTokens', 'ISpRecoResult', 'DISPID_SPRsCount',
    'DISPID_SVSCurrentStreamNumber', 'SPRECOGNIZERSTATUS',
    'SP_VISEME_5', 'SpeechInterference', 'SAFT12kHz8BitMono',
    'DISPID_SpeechPhraseReplacement', 'IStream',
    'DISPID_SPRulesCount', 'SpeechTokenKeyUI',
    'ISpeechRecognizerStatus', 'SVEStartInputStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRRAlternates',
    'SPEI_START_INPUT_STREAM', 'SpeechRuleState',
    'SRTExtendableParse', 'SPPS_Modifier',
    'DISPID_SLGetGenerationChange', 'DISPID_SVSInputSentencePosition',
    'eWORDTYPE_ADDED', 'ISpeechPhraseInfo', 'ISpGrammarBuilder',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRCCmdMaxAlternates',
    'SpMMAudioEnum', 'ISpResourceManager',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRCRecognizer',
    'SPRULESTATE', 'DISPID_SVGetVoices', 'DISPID_SPRules_NewEnum',
    'DISPID_SRGSetTextSelection', 'DISPID_SVGetProfiles',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPEDisplayText',
    'SDTPronunciation', 'SPXMLRESULTOPTIONS', 'SpeechVoiceEvents',
    'DISPID_SRStatus', 'ISpeechDataKey', 'SPVPRI_NORMAL',
    'SPBOOKMARKOPTIONS', 'DISPID_SPPName', 'SDKLCurrentUser',
    'DISPID_SPEAudioStreamOffset', 'eLEXTYPE_PRIVATE16', 'SITooQuiet',
    'SPCT_SUB_DICTATION', 'SREPrivate', 'SpeechVisemeFeature',
    'DISPID_SVEventInterests', 'DISPID_SpeechObjectTokenCategory',
    'eLEXTYPE_PRIVATE2', 'SREInterference', 'ISpeechPhraseAlternate',
    'DISPID_SPPConfidence', 'SpeechCategoryRecognizers',
    'SGRSTTDictation', 'SVF_Stressed', 'SECLowConfidence',
    'DISPID_SPACommit', 'SPADAPTATIONRELEVANCE', 'DISPID_SVPriority',
    'SpeechVoiceCategoryTTSRate', 'SVP_21', 'ISpRecoGrammar',
    'SVSFIsFilename', 'SAFT11kHz8BitStereo', 'DISPID_SRCVoice',
    'SPWF_INPUT', 'SDTRule', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_RESERVED7', 'SPSEMANTICFORMAT', 'ISpAudio',
    'DISPID_SOTsItem', 'SRERecognition', 'SGRSTTTextBuffer', 'SVP_15',
    'SLODynamic', 'DISPID_SGRName', 'SpWaveFormatEx',
    'DISPID_SDKOpenKey', 'eLEXTYPE_VENDORLEXICON',
    'SDKLCurrentConfig', 'SPAO_NONE', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechBookmarkOptions', 'DISPID_SpeechRecoResult2',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_RESERVED8',
    'SpeechAudioFormatType', 'DISPID_SRRSpeakAudio', 'SVSFlagsAsync',
    'SPEI_VISEME', 'SWPUnknownWordPronounceable', 'SpeechAudioVolume',
    'DISPID_SFSClose', 'DISPID_SOTCreateInstance', 'ISpNotifySource',
    'SpeechWordPronounceable', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechResourceLoader',
    'SRESoundEnd', 'SPPS_RESERVED2', 'DISPID_SLPsItem',
    'SPBINARYGRAMMAR',
    ...
    'DISPID_SPPsCount', 'DISPID_SPRsItem', 'SpeechTokenKeyAttributes',
    'DISPID_SOTGetDescription', 'SPBO_TIME_UNITS',
    'DISPID_SMSGetData', 'SGSExclusive',
    'SpeechGrammarTagUnlimitedDictation', 'SSFMOpenReadWrite',
    'SPVPRIORITY', 'SPINTERFERENCE_TOOQUIET',
    'SpeechStreamSeekPositionType', 'SGPronounciation',
    'SPCT_DICTATION', 'DISPID_SpeechLexicon', 'SPSHT_Unknown',
    'DISPIDSPRG', 'DISPID_SOTGetStorageFileName', 'DISPID_SOTCSetId',
    'SpeechAllElements', 'eLEXTYPE_PRIVATE19', 'DISPID_SBSFormat',
    'DISPID_SRGCmdLoadFromMemory', 'SPPS_SuppressWord',
    'SAFT11kHz16BitStereo', 'DISPID_SpeechXMLRecoResult',
    'SRADefaultToActive', 'SPDKL_CurrentConfig', 'SLTUser', 'SASRun',
    'SpInprocRecognizer', 'SPAO_RETAIN_AUDIO', 'SECFNoSpecialChars',
    'SRAORetainAudio', 'ISpeechPhraseAlternates', 'DISPID_SLPType',
    'eLEXTYPE_PRIVATE5', 'ISpeechRecognizer', 'SPWAVEFORMATTYPE',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechLexiconWord',
    'SP_VISEME_3', 'ISpeechCustomStream',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRGetPropertyString',
    'SAFTADPCM_11kHzStereo', 'SPPS_RESERVED1',
    'SpeechRecognitionType', 'DISPID_SpeechRecognizer',
    'DISPID_SPRulesItem', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRCState', 'DISPID_SVWaitUntilDone',
    'DISPID_SDKSetBinaryValue', 'SPEVENT', 'DISPID_SABIBufferSize',
    'SVEEndInputStream', 'SPWORDPRONOUNCEABLE', 'SPVISEMES',
    'DISPID_SRGCmdLoadFromObject', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPRuleId', 'DISPID_SDKGetlongValue', 'SRAONone',
    'SVSFVoiceMask', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRGRecoContext', 'ISpeechVoice', 'DISPID_SVRate',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVEAudioLevel',
    'SAFT22kHz8BitMono', 'DISPID_SRGetRecognizers', 'SPEI_SOUND_END',
    'ISpeechRecoContext', 'SpeechAudioFormatGUIDWave',
    'SPEVENTSOURCEINFO', 'SITooFast', 'DISPID_SRIsUISupported',
    'DISPID_SOTCDefault', 'DISPID_SRCreateRecoContext',
    'ISpeechRecoResult', 'SpeechGrammarTagDictation', 'SVEPhoneme',
    'eLEXTYPE_PRIVATE20', 'DISPID_SGRInitialState', 'LONG_PTR',
    'DISPID_SMSADeviceId', 'DISPID_SLGetPronunciations',
    'SPPHRASERULE', 'DISPID_SRRAudio', 'SITooSlow',
    'DISPID_SGRSTText', 'SPSNoun', 'SAFT44kHz8BitMono',
    'DISPID_SpeechMemoryStream', 'SPWT_DISPLAY', 'tagSPPROPERTYINFO',
    'SpeechTokenIdUserLexicon', 'SPEI_UNDEFINED', 'SGRSTTWildcard',
    'DISPID_SGRId', 'DISPID_SRCERecognition', 'DISPID_SGRsItem',
    'SBONone', 'SPRST_INACTIVE', 'UINT_PTR', 'SPINTERFERENCE_NOISE',
    'SAFTCCITT_uLaw_22kHzMono', 'SVP_6', 'DISPID_SVEPhoneme',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechPhraseRule', 'DISPID_SLWsCount', 'DISPID_SVVolume',
    'SpUnCompressedLexicon', 'ISpXMLRecoResult',
    'SPSEMANTICERRORINFO', 'ISpeechPhraseProperties',
    'SPEI_TTS_BOOKMARK', 'SBOPause', 'SAFTADPCM_8kHzMono',
    'SpeechStreamFileMode', 'DISPID_SpeechObjectTokens',
    'SPEI_HYPOTHESIS', 'SPSERIALIZEDRESULT',
    'DISPID_SPRuleEngineConfidence', 'ISpeechXMLRecoResult',
    'DISPID_SOTRemove', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechVoice', 'SPVPRI_ALERT', 'DISPID_SRRAudioFormat',
    'DISPID_SLAddPronunciationByPhoneIds',
    'ISpPhoneticAlphabetConverter', 'SRTSMLTimeout',
    'SSFMCreateForWrite', 'DISPID_SRSClsidEngine', 'SRSEIsSpeaking',
    'SAFT24kHz8BitMono', 'SpMemoryStream', 'ISpeechFileStream',
    'DISPID_SVResume', 'ISpPhrase', 'DISPID_SRAudioInput',
    'SPDATAKEYLOCATION', 'STCInprocServer',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRSTs_NewEnum',
    'ISpPhoneConverter', 'SPPHRASEPROPERTY', 'SPINTERFERENCE',
    'SPEI_SR_BOOKMARK', 'ISpeechRecoGrammar', 'SPAS_CLOSED',
    'SAFT48kHz8BitStereo', 'SpeechGrammarWordType',
    'DISPID_SABufferInfo', 'ISpeechPhraseReplacements',
    'SpeechLexiconType', 'SAFT48kHz8BitMono',
    'DISPID_SRSSupportedLanguages', 'SWPUnknownWordUnpronounceable',
    'DISPID_SDKEnumKeys', 'SPCONTEXTSTATE',
    'DISPID_SRGDictationUnload', 'ISpRecoCategory',
    'SpeechDiscardType', 'SPRECORESULTTIMES', 'DISPID_SPRuleChildren',
    'SLOStatic', 'DISPID_SLWPronunciations',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRGCmdLoadFromResource',
    'SPSHT_OTHER', 'SPINTERFERENCE_NONE', 'SPPS_Noun',
    'DISPIDSPTSI_SelectionOffset', 'SpeechTokenShellFolder',
    'DISPID_SPRs_NewEnum', 'DISPID_SRIsShared', 'SVPAlert',
    'SpeechDictationTopicSpelling', 'ISpNotifyTranslator',
    'DISPID_SOTMatchesAttributes', 'SSFMOpenForRead',
    'DISPID_SVESentenceBoundary', 'SAFT22kHz8BitStereo',
    'SPFM_OPEN_READONLY', 'SPRS_ACTIVE', 'SP_VISEME_14',
    'SPEI_RESERVED5', 'ISpSerializeState', 'DISPID_SRSAudioStatus',
    'SpMMAudioOut', 'SpSharedRecognizer', 'SPEI_RESERVED6',
    'DISPID_SPAsCount', 'SP_VISEME_15', 'DISPID_SLPs_NewEnum',
    'SVSFParseMask', 'DISPID_SABIEventBias', 'SVP_17',
    'DISPIDSPTSI_SelectionLength', 'SP_VISEME_21', 'SPPROPERTYINFO',
    'DISPID_SPPParent', 'DISPID_SVGetAudioInputs',
    'SAFTCCITT_ALaw_22kHzMono', 'SVP_2', 'DISPID_SPELexicalForm',
    'DISPID_SLGetWords', 'SpeechPartOfSpeech', 'SPAUDIOBUFFERINFO',
    'SAFTDefault', 'DISPID_SRCRequestedUIType',
    'DISPID_SPERequiredConfidence', 'DISPID_SRCEAdaptation',
    'WAVEFORMATEX', 'SpStream', 'ISpeechMemoryStream',
    'DISPID_SVStatus', 'SPEI_FALSE_RECOGNITION',
    'Speech_Max_Word_Length', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechFileStream', 'SVP_4', 'SP_VISEME_11',
    'DISPID_SRCERecognitionForOtherContext', 'SPGS_EXCLUSIVE',
    'SECFIgnoreWidth', 'DISPID_SRGId', 'SPEI_MAX_SR',
    'STSF_LocalAppData', 'SREPropertyNumChange', 'SREStreamStart',
    'SAFTExtendedAudioFormat', 'SpeechTokenContext',
    'DISPID_SPIGrammarId', 'SGLexical', 'eLEXTYPE_PRIVATE11',
    'SAFT8kHz16BitStereo', 'SVSFDefault', 'SpLexicon',
    'SPDKL_LocalMachine', 'SPPS_Unknown',
    'SpTextSelectionInformation', 'SAFTADPCM_44kHzStereo',
    'SAFT16kHz8BitStereo', 'SAFT11kHz16BitMono', 'DISPID_SPIGetText',
    'SPCT_SLEEP', 'SVSFNLPMask', 'SRERequestUI', 'SPWORD',
    'SVEPrivate', 'DISPID_SPARecoResult', 'DISPID_SVGetAudioOutputs',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechMMSysAudio',
    'SDKLDefaultLocation', 'DISPID_SVEBookmark',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SVSpeakStream',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPIGetDisplayAttributes',
    'DISPIDSPTSI_ActiveLength', 'SPAS_RUN', 'SLTApp', 'SPCS_ENABLED',
    'SAFTADPCM_44kHzMono', 'Speech_Default_Weight', 'SVSFIsNotXML',
    'DISPID_SVEVoiceChange', 'DISPID_SGRAttributes', 'SRSInactive',
    'DISPID_SASFreeBufferSpace',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SVAudioOutputStream', 'SpeechPropertyResourceUsage',
    'Speech_StreamPos_Asap', 'DISPID_SGRSAddSpecialTransition',
    'SAFTCCITT_uLaw_8kHzMono', 'SPAR_High',
    'IInternetSecurityMgrSite', 'SDA_One_Trailing_Space',
    'SpeechRegistryUserRoot', 'STSF_AppData', 'DISPID_SVDisplayUI',
    'DISPID_SPIReplacements', 'ISpeechLexiconPronunciations',
    'SPRECOSTATE', 'SpStreamFormatConverter',
    'DISPID_SpeechObjectToken', 'SAFT32kHz16BitMono', 'DISPID_SPPId',
    'SAFTCCITT_uLaw_11kHzStereo', 'STSF_FlagCreate',
    'DISPID_SRCPause', 'SREPhraseStart', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCRetainedAudio', 'SpeechCategoryRecoProfiles',
    'SPDKL_DefaultLocation', 'SVSFUnusedFlags',
    'SAFTADPCM_8kHzStereo', 'SP_VISEME_1', 'DISPID_SLPSymbolic',
    'SAFTADPCM_22kHzMono', 'SPBO_AHEAD', 'SPSHORTCUTPAIRLIST',
    'SPCATEGORYTYPE', 'IEnumString', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechBaseStream', 'DISPID_SVSpeak', 'SREStreamEnd',
    'SpCustomStream', 'DISPID_SVAudioOutput', 'DISPID_SVEViseme',
    'SSFMCreate', 'DISPID_SPPChildren', 'SPINTERFERENCE_TOOLOUD',
    'SPAR_Medium', 'SECFIgnoreKanaType', 'DISPID_SRGCmdSetRuleState',
    'eLEXTYPE_USER', 'SPLEXICONTYPE', 'DISPID_SWFEFormatTag',
    'DISPID_SDKSetStringValue', 'SpeechVoiceSpeakFlags',
    'SPEI_MIN_SR', 'DISPID_SGRsCount', 'SPLOADOPTIONS',
    'DISPID_SWFEChannels', 'SP_VISEME_18', 'SpNullPhoneConverter',
    'SREPropertyStringChange', 'SVP_14', 'SPSMF_UPS',
    'SRSInactiveWithPurge', 'ISpLexicon', 'SGDSActiveWithAutoPause',
    'SRERecoOtherContext', 'DISPID_SLWsItem', 'SPEVENTENUM',
    'DISPID_SpeechAudio', 'DISPID_SpeechLexiconProns',
    'SPRST_ACTIVE_ALWAYS', 'SPRS_INACTIVE', 'SpeechGrammarState',
    'ISpeechLexiconWord', 'DISPID_SVEEnginePrivate',
    'ISpeechVoiceStatus', 'ISpProperties', 'ISpPhraseAlt',
    'SPEI_SR_AUDIO_LEVEL', 'ISpeechRecoResultTimes',
    'SpNotifyTranslator', 'DISPID_SpeechRecoResult', 'SDTAlternates',
    'SpeechDataKeyLocation', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechPhraseRule', 'eLEXTYPE_PRIVATE8', 'ISpeechObjectTokens',
    'ISpeechLexiconPronunciation', 'DISPID_SpeechPhraseAlternates',
    'SpPhoneConverter', 'DISPID_SDKDeleteValue',
    'SAFT12kHz16BitStereo', 'SpeechPropertyComplexResponseSpeed',
    'SPEI_RESERVED2', 'DISPID_SGRsAdd', 'SAFT32kHz16BitStereo',
    'ISpeechAudio', 'SRTEmulated', 'DISPID_SPRuleParent',
    'DISPID_SGRSTNextState', 'SVP_9', 'DISPID_SVSInputWordLength',
    'SRADynamic', 'SPPHRASE', 'SPPS_Function', 'SVEVoiceChange',
    'SPEI_SOUND_START', 'DISPID_SADefaultFormat', 'SREStateChange',
    'SPEI_TTS_PRIVATE', 'ISpObjectWithToken', 'SVSFParseAutodetect',
    'SDA_Consume_Leading_Spaces', 'SPGS_ENABLED',
    'DISPID_SVSLastResult', 'DISPID_SRGDictationSetState',
    'SPINTERFERENCE_TOOFAST', 'SVSFPersistXML',
    'DISPID_SRRGetXMLResult', 'SPSSuppressWord', 'SVP_13',
    'DISPID_SRRTimes', 'tagSTATSTG', 'DISPID_SPRText',
    'DISPID_SpeechPhoneConverter', 'DISPID_SOTRemoveStorageFileName',
    'SWTAdded', 'SAFT12kHz8BitStereo', 'ISpRecoGrammar2',
    'eLEXTYPE_MORPHOLOGY', 'SDTAudio', 'SAFTADPCM_11kHzMono',
    'SpObjectToken', 'SRAImport', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPILanguageId', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRRPhraseInfo', 'DISPID_SOTId', 'DISPID_SPPs_NewEnum',
    'SPFILEMODE', 'SAFT22kHz16BitStereo', 'SPWORDLIST', 'SVP_7',
    'SVP_16', 'DISPID_SLPPartOfSpeech', 'DISPID_SVSLastBookmark',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPEsItem',
    'DISPID_SFSOpen', 'DISPID_SPAStartElementInResult',
    'DISPID_SOTGetAttribute', 'STCLocalServer', 'DISPID_SRCEBookmark',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechVoiceEvent',
    'DISPID_SLPsCount', 'DISPID_SRGSetWordSequenceData',
    'SPGRAMMARSTATE', 'SSSPTRelativeToStart',
    'DISPID_SPIAudioSizeBytes', 'SPWORDPRONUNCIATIONLIST',
    'SGRSTTEpsilon', 'DISPID_SRCSetAdaptationData', 'SINoise',
    'DISPID_SASNonBlockingIO'
]

_check_version('1.2.0', 1662606453.242060)
